...
function catch_that_image() {
    ...
    if(empty($first_img)){ //Defines a default image
        $first_img = "http://extractheme.jpn.org/grid/wp-content/themes/extract_grid/img/noimage.gif";
    }
    return $first_img;
}
...
{?>
	<ul >
		<li class="tweetButton"><a href="http://twitter.com/share" class="twitter-share-button" data-url="<?php the_permalink(); ?>" data-text="<?php the_title(); ?>｜EXTRACT" data-count="horizontal" data-via="extractinc" data-lang="ja"></a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script></li>
		<li class="likeButton"><iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo urlencode(get_permalink($post->ID)); ?>&layout=button_count&show_faces=false&width=30&action=like&colorscheme=light" scrolling="no" frameborder="0" allowTransparency="true" style="border:none; overflow:hidden; width:132px; height:21px;"></iframe></li>
	</ul>
<?php
 }
